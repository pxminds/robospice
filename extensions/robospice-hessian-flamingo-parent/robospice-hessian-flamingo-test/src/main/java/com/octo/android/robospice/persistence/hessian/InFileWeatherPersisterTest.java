...
import com.octo.android.robospice.hessian.test.model.json.CurrenWeather;
import com.octo.android.robospice.hessian.test.model.json.Weather;
import com.octo.android.robospice.hessian.test.model.json.WeatherResult;
...
public class InFileWeatherPersisterTest extends AndroidTestCase {
    ...
    protected void setUp() throws Exception {
        ...
        HessianObjectPersisterFactory factory = new HessianObjectPersisterFactory(application);
    ...
    public void test_loadDataFromCache_expired() throws Exception {
        ...
        dataPersistenceManager.saveDataToCacheAndReturnData(weatherRequestStatus, FILE_NAME);
        File cachedFile = ((HessianObjectPersister<?>) dataPersistenceManager).getCacheFile(FILE_NAME);
